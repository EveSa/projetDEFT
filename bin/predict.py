...
def random_forest(name, lang, X_train, y_train, X_test, max_depth=None):
...
def logistic_regression(name, lang, X_train, y_train, X_test):
    '''
...
def linearsvc_classification(name, lang, X_train, y_train, X_test):
    '''
...
def svc_classification(name, lang, X_train, y_train, X_test):
    '''
    svc classifiation training 
    '''
...
def SGD_classification(name, lang, X_train, y_train, X_test):
    '''train SGD'''
